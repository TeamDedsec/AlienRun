...
import com.example.kaloyanit.alienrun.Views.leaderboard.LeaderboardModule;
 ...
 */
@Module(includes = {MainModule.class, PlayersModule.class, SettingsModule.class, AchievementsModule.class, LeaderboardModule.class})
