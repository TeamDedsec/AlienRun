...
public class BlockSetFactory {
    public static BlockSet createBlockSet(BlockSetType type) {
        switch (type) {
            case Grass:
                return new BlockSet(BitmapFactory.decodeResource(BasicConstants.CURRENT_CONTEXT.getResources(), R.drawable.grassleft),
            ...
            case Sand:
                return new BlockSet(BitmapFactory.decodeResource(BasicConstants.CURRENT_CONTEXT.getResources(), R.drawable.sandleft),
            ...
            case Snow:
                return new BlockSet(BitmapFactory.decodeResource(BasicConstants.CURRENT_CONTEXT.getResources(), R.drawable.snowleft),
            ...
            case Rock:
                return new BlockSet(BitmapFactory.decodeResource(BasicConstants.CURRENT_CONTEXT.getResources(), R.drawable.dirtleft),
